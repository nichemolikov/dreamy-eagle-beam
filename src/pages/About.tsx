  ...
  return (
    <div>
      <section
        ...
        style={{ backgroundImage: "url(https://wallpaperaccess.com/full/1669455.jpg)" }}
      >
      ...
      <div className="container mx-auto p-4 md:p-8">
        <div className="max-w-4xl mx-auto text-muted-foreground space-y-8 text-lg">
          ...
          <p className="text-center text-xl leading-relaxed">
            Ние сме вашият доверен партньор за денонощна пътна помощ и професионален автосервиз. С дългогодишен опит, екип от специалисти и модерно оборудване, предлагаме бърза и ефективна реакция при всякакви пътни инциденти – 24 часа в денонощието, 7 дни в седмица.
          </p>
          ...
          <h3 className="text-2xl font-bold text-black mt-10 mb-4 flex items-center gap-2">
